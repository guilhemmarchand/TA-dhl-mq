...
import modalert_mq_publish_message_relay_3_helper

class AlertActionWorkermq_publish_message_relay_3(ModularAlertBase):

    def __init__(self, ta_name, alert_name):
        super(AlertActionWorkermq_publish_message_relay_3, self).__init__(ta_name, alert_name)
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            if not self.validate_params():
                return 3
            status = modalert_mq_publish_message_relay_3_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkermq_publish_message_relay_3("TA-dhl-mq", "mq_publish_message_relay_3").run(sys.argv)
    sys.exit(exitcode)
