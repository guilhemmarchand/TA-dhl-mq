...
logger = log.Logs().get_logger('ta-dhl-mq_rh_oauth2_token')
...
class ta-dhl-mq_rh_oauth2_token(admin.MConfigHandler):
    ...
    def getProxyDetails(self):
        ...
        ), "TA-dhl-mq", realm="__REST_CREDENTIAL__#TA-dhl-mq#configs/conf-ta-dhl-mq_settings")
        # Get Conf object of apps settings
        conf = cfm.get_conf('ta-dhl-mq_settings')
...
if __name__ == "__main__":
    admin.init(ta-dhl-mq_rh_oauth2_token, admin.CONTEXT_APP_AND_USER)